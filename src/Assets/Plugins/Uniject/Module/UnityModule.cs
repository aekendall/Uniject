...
public class UnityModule : NinjectModule {
    ...
    public override void Load() {
        ...
        Bind<ITexture2D>().To<UnityTexture2D>().InScope(Scoping.GameObjectBoundaryScoper);
        ...
        Bind<Texture2D>().ToProvider<ResourceProvider<Texture2D>>().WhenTargetHas(typeof(Resource));
